...
def brawBox(img,bbox):
    x,y,w,h = int(bbox[0]),int(bbox[1]),int(bbox[2]),int(bbox[3])
    cv2.rectangle(img,(x,y),((x+w),(y+h)),(255,255,0),3,1)
    cv2.putText(img,"traking",(75,90),cv2.FONT_HERSHEY_COMPLEX,0.7,(0,0,250),2)
...
while True:
    ...
    if sucess:
        ...
        cv2.putText(img,"lost",(75,90),cv2.FONT_HERSHEY_COMPLEX,0.7,(0,0,250),2)
